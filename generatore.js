...
function fightGenerator() {
    ...
    switch (num) {
        case 1:
            ...
            story.innerHTML = "Emidio è un pingue e amichevole rospo santone devoto a Santa Irene. Interessato al pettegolezzo e al sollazzo in parti uguali, ne sa una più del diavolo anche perché, se no, che santone sarebbe. Parla anche con le pietre della strada, non lascia niente di intentato, è la memoria storica del suo gruppo. Ricorda più le ricette delle preghiere e produce birra artigianale. Ha un animo ambiguo, vuole sapere sempre tutto ma di lui si sa poco, solo quello che lascia trasparire tra una portata e l'altra.";
        ...
        case 3:
            ...
            story.innerHTML = "Giannina è un’orsa anziana, vedova di lupo di mare che ogni tanto “scuoteva” per convincerlo di avere ragione. Dalla scomparsa del Compagno ha capito che la vita và vissuta bene, e per questo ha iniziato a fumare cicoria e giocare a carte con chiunque le capiti a tiro. Per Giannnina il cibo è sacro, anche se cade dal tavolo “basta soffiare”, e va’ mangiato tutto in un sol boccone. Sempre! Si narra che è impossibile mangiare lo stufato velocemente come lei, alcuni giurano di averla vista rincorrere un istrice per cibarsene.";
